...
Исправлено восстановление прогресса для старых сессий без манифеста покрытия; сохранены встроенный промпт и улучшения прогресса просмотрщика из версии 1.0.3.
